...
const Homepage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const startDate = new Date(result.start_date + 'T' + result.start_time + 'Z');
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="container flex flex-col ml-56 border border-gray-600 h-72 w-72 rounded-lg lg:h-96 md:h-44 mr-20">
          <div className="flex flex-col">
            ...
            <h2 className="mx-5 text-sm font-semibold mt-1">
              ...
              <span className="ml-2 font-light">
                {data.start_date} {data.start_time} - {data.end_date} {data.end_time} IST
              </span>
            </h2>
            ...
            <span className="mx-5 mt-1 text-xl font-extrabold ">{formatTime(timeRemaining)}</span>
            ...
            <div className="flex justify-center mt-2">
              <div className="bg-slate-400 h-8 w-60 flex justify-center rounded-sm ">
                <button className="text-sm text-yellow-50">Offical Website</button>
              </div>
            </div>
